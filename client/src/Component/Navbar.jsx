export default function Navbar({ loggedIn }){
    return(
        <div style={{ display:'flex', justifyContent: 'space-around', alignItems: 'center', boxShadow: '0px 3px #D9D9D9', height: 90, position: 'sticky', top: 0, zIndex: 1, backgroundColor: "white" }}>
            <div>
