    ...
    return(
       <div style={{ display:'flex', justifyContent: 'space-around', alignItems: 'center', boxShadow: '0px 3px #1CDDDB', position: 'sticky', top: 0, zIndex: 1, backgroundColor: "white", height: '100px', position: 'fixed' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <div><button onClick={handleLogout} style = {{ cursor: 'pointer', fontWeight: 'bold', borderRadius: 20, border: 'none', padding: 10, paddingRight: 25, paddingLeft: 25, backgroundColor: '#5785E8', color: 'white', width: 150, marginRight: '5vh' }}>Logout</button></div>
                </>
                }
                {loggedIn == false &&
                <>
