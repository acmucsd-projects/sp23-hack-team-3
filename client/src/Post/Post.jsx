        ...
        <>
            ...
            <form onSubmit={handlePost}>
                ...
                <div className="locationDropDown" style = {{ marginTop: 20, textAlign: "center" }}>
                    <select defaultValue="" required onChange = {dropDownChange} style={{ width: '51%', height: '40px', backgroundColor: '#D9D9D9', borderRadius: 8, paddingLeft: 10, border: 0, outline: 'solid 2', outlineColor: 'black', paddingTop: 5, paddingBottom: 5, fontSize: '16px'}} >
                ...
                { failed && <p style={{ color: 'red', textAlign: 'center' }}>Error. Please make sure to fill in all Basic Information and only upload an image file.</p>}
